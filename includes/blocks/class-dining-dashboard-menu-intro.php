...
class MenuIntro {
    ...
    public function render( $attributes ){
        ...
        $variables[ 'legend_title' ] = 
            isset( $attributes[ 'legendTitle' ] ) ? 
            self::parse_html( $attributes[ 'legendTitle' ] ) : 
            'Dietary Requirements';
        $variables[ 'show_vegetarian' ] = isset( $attributes[ 'showVegetarianDesc' ] ) ? $attributes[ 'showVegetarianDesc' ] : true;
        $variables[ 'vegetarian_description' ] = 
            isset( $attributes[ 'vegetarianDescription' ] ) ? 
            self::parse_html( $attributes[ 'vegetarianDescription' ] ) : 
            'Vegetarian or vegetarian options available.';
        $variables[ 'show_vegan' ] = isset( $attributes[ 'showVeganDesc' ] ) ? $attributes[ 'showVeganDesc' ] : true;
        $variables[ 'vegan_description' ] = 
            isset( $attributes[ 'veganDescription' ] ) ? 
            self::parse_html( $attributes[ 'veganDescription' ] ) : 
            'Vegan or vegan options available.';
        $variables[ 'show_gluten_free' ] = isset( $attributes[ 'showGlutenFreeDesc' ] ) ? $attributes[ 'showGlutenFreeDesc' ] : true;
        $variables[ 'gluten_free_description' ] = 
            isset( $attributes[ 'glutenFreeDescription' ] ) ? 
            self::parse_html( $attributes[ 'glutenFreeDescription' ] ) : 
            'Gluten free or gluten free options available.';
